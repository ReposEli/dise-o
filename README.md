...
* **API Gateway:** Integrar **Kong** como Ingress Controller en K8s para manejar el enrutamiento de tráfico externo y la seguridad JWT de forma centralizada.# dise-o
